...
fn apply_model_catalog_to_config(
    ...
    // Managed API Responses transports use standard tools regardless of session identity.
    // Native official and Chat Completions profiles retain the template's Lite behavior.
