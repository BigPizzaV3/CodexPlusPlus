...
export const EN_PLAIN: Record<string, string> = {
  ...
  "编辑模型元数据": "Edit model metadata",
  "模型高级设置": "Advanced model settings",
  "模型增量配置": "Incremental model configuration",
  "模型配置": "Model settings",
  ...
  "推理": "Reasoning",
  "默认": "Default",
  "回答篇幅可调": "Adjustable response length",
  "并行工具": "Parallel tools",
  "未声明，保持 Codex 默认": "Not declared; keep Codex defaults",
  "自动（不覆盖）": "Automatic (no override)",
  "自定义（{0}）": "Custom ({0})",
  "仅在供应商声明不准确时手动覆盖；通常通过 model.js 导入。":
    "Override only when the provider declaration is inaccurate; normally import it from model.js.",
  "自动：上下文窗口的 90%": "Automatic: 90% of the context window",
  "查看 JSON（{0}）": "View JSON ({0})",
  "推理档位": "Reasoning level",
  "详细程度": "Verbosity",
  "回答篇幅": "Response length",
  "回答详略": "Response detail",
  "控制回答偏简洁还是偏详细，不代表固定字数。":
    "Controls whether responses are concise or detailed; it does not set a fixed length.",
  "不支持篇幅控制": "Response length control unsupported",
  "支持，使用模型默认": "Supported; use model default",
  "简洁（low）": "Concise (low)",
  "适中（medium）": "Balanced (medium)",
  "详细（high）": "Detailed (high)",
  "无（none）": "None",
  "极简（minimal）": "Minimal",
  "低（low）": "Low",
  "中（medium）": "Medium",
  ...
  "压缩触发 token 数": "Compaction trigger tokens",
  "留空按上下文窗口的 90% 计算": "Leave blank to use 90% of the context window",
  "填写绝对 token 数，不是百分比；留空时 Codex 按上下文窗口的 90% 计算。":
    "Enter an absolute token count, not a percentage; when blank, Codex uses 90% of the context window.",
  "{0} 项覆盖": "{0} overrides",
  "继承默认": "Inherit default",
  "JSON（{0}）": "JSON ({0})",
  "只保留需要人工决定的覆盖项；模型能力由 model.js 导入。":
    "Only user-selected overrides are shown; model capabilities come from model.js.",
  "回答详细程度": "Response verbosity",
  "不支持 Verbosity": "Verbosity unsupported",
  "支持，默认档位继承": "Supported; inherit default level",
  "留空由 Codex 自动计算": "Leave empty for Codex to calculate",
  "工具、搜索、图片和 Responses 协议能力由 model.js 导入，不在这里重复配置。":
    "Tool, search, image, and Responses protocol capabilities are imported from model.js and are not duplicated here.",
  "查看原始覆盖 JSON（{0} 项）": "View raw override JSON ({0} fields)",
  "已识别 {0} 项配置；兼容转换 {1} 项；需注意 {2} 项。":
    "Recognized {0} fields; {1} compatibility mappings; {2} need attention.",
  "仅设置需要覆盖的项目；其余配置继续继承 Codex 默认模型元数据。":
    "Only set the values you need to override; everything else continues to inherit Codex model metadata.",
  "继承 Codex 默认": "Inherit Codex defaults",
  "已覆盖 {0} 项": "{0} overrides",
  "已启用增量覆盖": "Incremental overrides enabled",
  "当前没有自定义覆盖": "No custom overrides",
  "只有已设置或导入的字段会覆盖默认值，其他字段仍由 Codex 决定。":
    "Only fields you set or import override defaults; Codex still decides all other fields.",
  "打开本面板不会写入配置；保存后仍使用 Codex 自带的模型默认值。":
    "Opening this panel does not write any configuration; Codex model defaults remain in use after saving.",
  "导入 models.json": "Import models.json",
  "重新导入 models.json": "Re-import models.json",
  "查看或重新导入 models.json": "View or re-import models.json",
  "清除导入配置": "Clear imported configuration",
  "清除已导入的模型字段，保留上下文窗口": "Clear imported model fields and keep the context window",
  "替换此模型配置": "Replace this model configuration",
  "上下文窗口与自动压缩值无效，无法同步模型配置。":
    "The context window or auto-compact value is invalid, so the model configuration cannot be synchronized.",
  "模型名称重复：{0}": "Duplicate model name: {0}",
  "模型 {0} 的上下文窗口无效；请输入正整数，或使用 K/M 整数后缀。":
    "The context window for model {0} is invalid. Enter a positive integer or an integer with a K/M suffix.",
  "模型 {0} 的自动压缩百分比无效；请输入 0 到 100 之间、最多 6 位小数的十进制数。":
    "The auto-compact percentage for model {0} is invalid. Enter a decimal greater than 0 and at most 100, with up to 6 decimal places.",
  "已导入": "Imported",
  "已导入 · 上下文 {0}": "Imported · Context {0}",
  "粘贴 models.json 内容": "Paste models.json content",
  "自动压缩": "Auto-compact",
  "导入对应模型的 model.json 字段。支持多模型文件，自动匹配同名模型。":
    "Import the model.json fields for the corresponding model. Supports multi-model files and auto-matches models with the same name.",
  "支持多模型文件，自动匹配同名模型。":
    "Supports multi-model files and automatically matches the model with the same name.",
  "上下文窗口与当前模型的 context_window 保持同步。":
    "The context window stays synchronized with context_window for the current model.",
  "上下文窗口与自动压缩会和当前模型的 context_window、auto_compact_token_limit 保持同步。":
    "Context window and auto-compact stay synchronized with context_window and auto_compact_token_limit for the current model.",
  "清除覆盖": "Clear overrides",
  "从模型配置文档导入": "Import from a model configuration document",
  "粘贴供应商提供的 model.js 或 JSON；将按当前模型 slug 读取，并与已有覆盖增量合并。":
    "Paste vendor-provided model.js or JSON. It is matched by the current model slug and merged with existing overrides.",
  "粘贴 model.js / JSON 配置": "Paste model.js / JSON configuration",
  "解析并应用": "Parse and apply",
  "已覆盖 {0} 项；其余字段继承 Codex 默认。": "{0} overrides; all other fields inherit Codex defaults.",
  "当前完全继承 Codex 默认，打开面板不会写入配置。":
    "Currently inheriting all Codex defaults. Opening this panel does not write configuration.",
  "{0} 项自定义覆盖": "{0} custom overrides",
  "默认窗口": "Default window",
  "全部继承默认": "Inherit all defaults",
  "导入供应商模型文档": "Import vendor model document",
  "先解析预览，再决定是否应用；不会执行 JavaScript。":
    "Parse and preview before applying. JavaScript is never executed.",
  "识别字段": "Recognized",
  "兼容转换": "Compatibility mappings",
  "兼容重复": "Compatibility duplicates",
  "需注意": "Needs attention",
  "上下文窗口将同步为 {0}。": "The context window will be synchronized to {0}.",
  "兼容转换：": "Compatibility mappings: ",
  "为兼容旧版 Codex 保留：": "Kept for older Codex versions: ",
  "供应商级字段：": "Provider-level fields: ",
  "当前客户端可能忽略：": "The current client may ignore: ",
  "应用增量覆盖": "Apply incremental overrides",
  "模型设置分类": "Model settings categories",
  "常用设置": "Common settings",
  "Responses 兼容性": "Responses compatibility",
  "原始配置": "Raw configuration",
  "推理与表达": "Reasoning and expression",
  "只设置供应商明确支持的能力；留空继续继承。":
    "Only set capabilities explicitly supported by the provider; leave blank to inherit.",
  "默认 Verbosity": "Default verbosity",
  "支持 Verbosity": "Supports verbosity",
  "明确开启": "Explicitly enabled",
  "明确关闭": "Explicitly disabled",
  "支持的推理档位": "Supported reasoning levels",
  "继承 Codex 模型模板": "Inherit Codex model template",
  "输入与工具": "Input and tools",
  "这些字段决定客户端如何组装请求和展示输入能力。":
    "These fields control request construction and advertised input capabilities.",
  "输入类型": "Input modalities",
  "仅文本": "Text only",
  "文本与图片": "Text and images",
  "文本、图片与音频": "Text, images, and audio",
  "原始图片精度": "Original image detail",
  "第三方 Responses 安全基线": "Third-party Responses safety baseline",
  "Codex++ 已默认关闭 Responses Lite；其他字段仅在这里明确设置后覆盖。":
    "Codex++ disables Responses Lite by default; other fields override only when explicitly set here.",
  "请求协议": "Request protocol",
  "错误继承这些字段可能导致 400、工具缺失或协作模式不兼容。":
    "Incorrectly inherited values can cause HTTP 400 errors, missing tools, or incompatible collaboration modes.",
  "明确关闭 (null)": "Explicitly disabled (null)",
  "推理与截断": "Reasoning and truncation",
  "旧版与新版 reasoning 字段会同时写入，以保持兼容。":
    "Legacy and current reasoning fields are written together for compatibility.",
  "Reasoning Summary 参数": "Reasoning Summary parameter",
  "默认 Reasoning Summary": "Default Reasoning Summary",
  "截断单位": "Truncation unit",
  "截断上限": "Truncation limit",
  "有效窗口百分比": "Effective window percentage",
  "继承默认，例如 95": "Inherit default, for example 95",
  "每模型压缩阈值": "Per-model compaction threshold",
  "留空自动计算": "Leave blank to calculate automatically",
  "当前模型的增量覆盖 JSON": "Incremental override JSON for this model",
  "这里只显示当前 slug；未出现的字段继续继承 Codex 默认。":
    "Only the current slug is shown; omitted fields continue to inherit Codex defaults.",
  "撤销编辑": "Discard edits",
  "应用 JSON": "Apply JSON",
  "原始配置必须是一个 JSON 对象。": "Raw configuration must be a JSON object.",
  "JSON 格式不正确，请检查后重试。": "Invalid JSON. Check the content and try again.",
  "默认推理档位": "Default reasoning level",
  "默认回答详略": "Default response detail",
  "选项来自模型声明的 supported_reasoning_levels。":
    "Options come from the model's declared supported_reasoning_levels.",
  "模型已声明支持回答详略；这里只修改 default_verbosity。":
    "The model declares verbosity support; this only changes default_verbosity.",
  "不启用推理 (none)": "No reasoning (none)",
  "低 (low)": "Low (low)",
  "中 (medium)": "Medium (medium)",
  "高 (high)": "High (high)",
  "超高 (xhigh)": "Extra high (xhigh)",
  "最大 (max)": "Maximum (max)",
  "工具模式": "Tool mode",
  "仅代码模式 (code_mode_only)": "Code mode only (code_mode_only)",
  "搜索工具类型": "Web search type",
  "仅文本 (text)": "Text only (text)",
  "文本与图片 (text_and_image)": "Text and images (text_and_image)",
  "能力覆盖": "Capability overrides",
  "关闭 Responses Lite": "Disable Responses Lite",
  "开启后明确禁用；关闭时继承模型默认值。":
    "Turn on to explicitly disable it; turn off to inherit the model default.",
  "并行工具调用": "Parallel tool calls",
  "搜索工具": "Search tool",
  "开启后标记为支持；关闭时继承模型默认值。":
    "Turn on to mark this capability as supported; turn off to inherit the model default.",
  "系统提示词": "System prompt",
  "留空使用 Codex 默认系统提示词": "Leave empty to use Codex default system prompt",
  "对应 catalog 字段：": "Catalog field: ",
  "使用默认": "Use default",
...
export const EN_BACKEND: Record<string, string> = {
  ...
  "请先粘贴 model.js 或 JSON 配置。": "Paste a model.js or JSON configuration first.",
  "当前模型名称为空，无法匹配 slug。": "The current model name is empty, so its slug cannot be matched.",
  "无法解析配置。仅支持 JSON，或 export default / module.exports 包裹的 JSON；不会执行 JavaScript。": "Unable to parse the configuration. Only JSON, or JSON wrapped by export default / module.exports, is supported; JavaScript is never executed.",
  "配置中没有找到 models 数组或带 slug 的模型对象。": "No models array or model object with a slug was found in the configuration.",
  "context_window 必须是正整数。": "context_window must be a positive integer.",
  "auto_compact_token_limit 必须是正整数或 null。": "auto_compact_token_limit must be a positive integer or null.",
  "存在 auto_compact_token_limit 时必须同时提供 context_window。": "context_window is required when auto_compact_token_limit is provided.",
  "auto_compact_token_limit 必须小于或等于 context_window。": "auto_compact_token_limit must be less than or equal to context_window.",
  "supported_reasoning_levels 必须是数组。": "supported_reasoning_levels must be an array.",
  "supported_reasoning_levels 的每一项都必须包含 effort 和 description 字符串。": "Every supported_reasoning_levels item must contain effort and description strings.",
  "default_reasoning_level 必须是非空字符串。": "default_reasoning_level must be a non-empty string.",
  "support_verbosity 必须是 true 或 false。": "support_verbosity must be true or false.",
  "default_verbosity 必须是非空字符串。": "default_verbosity must be a non-empty string.",
};
...
export const EN_BACKEND_PATTERNS: Array<[RegExp, string]> = [
  [/^文档中没有找到当前模型 slug：(.+?)。 文档包含：(.+)。$/, "The document does not contain the current model slug: $1. Available slugs: $2."],
  [/^文档中没有找到当前模型 slug：(.+?)。$/, "The document does not contain the current model slug: $1."],
  [/^文档中存在多个 slug 为 (.+?) 的模型，无法确定要导入哪一个。$/, "The document contains multiple models with slug $1, so the import target is ambiguous."],
