...
export const EN_PLAIN: Record<string, string> = {
  ...
  "选择图片": "Select image",
  "选择文件": "Select file",
  "选择 models.json": "Select models.json",
  "选择或输入 models.json 路径": "Choose or enter models.json path",
  "自定义模型目录": "Custom model catalog",
  "启用自定义模型目录": "Enable custom model catalog",
  "启动 Codex 前将本地 models.json 与基础目录合并，覆盖模型元数据。": "Merge a local models.json with the base catalog before launching Codex, overriding model metadata.",
  "选择本地 models.json，启动 Codex 前按 slug 合并到有效目录。禁用时恢复原始配置。": "Select a local models.json to merge into the effective catalog by slug before launching Codex. Disabling restores the original config.",
  "模型目录文件": "Catalog file",
