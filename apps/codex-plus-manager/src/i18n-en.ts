...
export const EN_PLAIN: Record<string, string> = {
  ...
  "SSH 主机别名": "SSH host alias",
  "SSH 远端同步": "SSH remote sync",
  ...
  "远端同步配置不完整": "Remote sync configuration is incomplete",
  "请先填写 SSH 主机别名。": "Enter an SSH host alias first.",
  "本地已切换，但远端同步没有返回结果。": "The local provider switched, but remote sync returned no result.",
  "请先启用 SSH 远端同步。": "Enable SSH remote sync first.",
  "远端同步没有返回结果。": "Remote sync returned no result.",
  "同步到 SSH 远端": "Sync to an SSH remote",
  "切换供应商时同步路由与认证；远端会先备份，并保留项目、插件和功能配置。":
    "Sync routing and authentication when switching providers. The remote is backed up first, while project, plugin, and feature configuration is preserved.",
  "例如 build-host 或 user@example.com": "e.g. build-host or user@example.com",
  "远端 CODEX_HOME": "Remote CODEX_HOME",
  "留空使用 ~/.codex": "Leave empty to use ~/.codex",
  "把当前供应商的路由与认证立即同步到 SSH 远端": "Sync the active provider routing and authentication to the SSH remote now",
  "同步中": "Syncing",
  "立即同步": "Sync now",
  "需要本机 OpenSSH 和无交互密钥认证；仅同步到你信任的主机。":
    "Requires local OpenSSH and non-interactive key authentication. Only sync to hosts you trust.",
  ...
  "供应商操作还没有完成，请稍后再试。": "A provider operation is still running. Please try again shortly.",
  ...
  "保存设置": "Save settings",
  "保存路径": "Saved path",
  "保存当前供应商快照失败，已停止远端同步。": "Failed to save the active provider snapshot. Remote sync was stopped.",
...
export const EN_TEMPLATE: Record<string, string> = {
  ...
  "本地已切换；{0}": "Local provider switched; {0}",
  "本地与 {0} 已切换到 {1}。": "Local and {0} switched to {1}.",
  "本地已切换到 {0}。": "Local provider switched to {0}.",
  "已将 {0} 同步到 {1}。": "Synced {0} to {1}.",
...
export const EN_BACKEND_PATTERNS: Array<[RegExp, string]> = [
  ...
  [/^SSH 远端同步未启用。$/, "SSH remote sync is not enabled."],
  [/^远端供应商已同步，旧 app-server 已停止并等待 Codex 自动重连。$/, "Remote provider synchronized. The previous app-server was stopped and Codex can reconnect automatically."],
  [/^远端供应商同步失败：(.+)$/, "Remote provider sync failed: $1"],
  [/^远端供应商同步任务异常：(.+)$/, "Remote provider sync task failed unexpectedly: $1"],
