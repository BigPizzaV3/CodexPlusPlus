...
| `xuan-workspace-search` | `0.1.0` | bridge protocol `1` | MCP schema or result-shape change |
| `xuan-usage` | `0.1.0` | bridge protocol `1` | Provider adapter or credential contract change |
| `xuan-polish` | `0.1.0` | bridge protocol `1`, user-script ABI `0` | Composer DOM/bridge URL change |
| `xuan-bridge` | `0.1.0` | plugin protocol `1` | JSON API or persistent-state migration |
